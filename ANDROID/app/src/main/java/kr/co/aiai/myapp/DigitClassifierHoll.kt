...
class DigitClassifierHoll(private val context: Context) {
  ...
  private fun initializeInterpreter() {
    ...
    Log.d("taekwon95:FL", DigitClassifierHoll.FLOAT_TYPE_SIZE.toString())
    Log.d("taekwon95:Width",inputImageWidth.toString())
    Log.d("taekwon95:Height",inputImageHeight.toString())
    Log.d("taekwon95:PIXEL_SIZE", DigitClassifierHoll.PIXEL_SIZE.toString())
  ...
  private fun getInputHoll(mine:String): ByteBuffer {
  ...
  companion object {
    ...
    private const val MODEL_FILE = "holl.tflite"
